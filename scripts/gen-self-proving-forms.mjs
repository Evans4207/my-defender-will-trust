...
const EXTRACT = {
  ...
  SD: { from: "I,", to: "(b)" },
  UT: { from: "I,", to: "(2)" },
  KY: { from: "I,", to: "(2) An attested will may" },
  ME: { from: "I,", to: "2." },
  MA: { from: "I,", to: "(b) An attested will may be made self-proved" },
  MI: { from: "I,", to: "(2)" },
  NC: { from: "I,", to: "(b) An attested written will" },
  // Texas prints two forms; this is § 251.1045's simultaneous-execution form.
  TX: { from: "I,", to: "(b) A will that is in substantial compliance" },
